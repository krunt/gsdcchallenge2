...
public:
    psr_doppler_fusion(const std::string& rtkSolPath)
    {
...
int main(int argc, char **argv)
{
    ...
    psr_doppler_fusion psr_doppler_fusion(solPath);
    ...
    int msgCount = 0;
    for (; dopIt != dopplerView.end() && rawIt != rawView.end() && stationIt != stationView.end(); 
        ++dopIt, ++rawIt, ++stationIt)
    {
        ...
        psr_doppler_fusion.addEpochMessages(gnssMsg, dopplerMsg);
    ...
    psr_doppler_fusion.solveOptimization();
